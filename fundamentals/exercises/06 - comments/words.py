"""
Inline comments begin with a hash symbol # and continue until the end of line.

They can be used to explain why a certain implementation decision was made, as in L49
"""
import sys
